...
krish_image = face_recognition.load_image_file("Known/krish.jpg")
krish_face_encoding = face_recognition.face_encodings(krish_image)[0]

# Load a second sample picture and learn how to recognize it.
bradley_image = face_recognition.load_image_file("Known/bradley.jpg")
bradley_face_encoding = face_recognition.face_encodings(bradley_image)[0]

suresh_image = face_recognition.load_image_file("Known/Suresh.png")
